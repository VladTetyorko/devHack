...
/**
 * Standalone tests for the BCryptPasswordEncoder used in the application.
 * These tests verify the basic functionality of the password encoder without Spring context.
 */
public class PasswordEncoderTest {
    ...
    @Test
    public void testDifferentHashesForSamePassword2() {
        // Given
